...
const playfair_1 = require("./playfair");
describe('Playfair Cipher', () => {
    it('generates the correct grid', () => {
        const grid = (0, playfair_1.generatePlayfairGrid)('PLAYFAIR EXAMPLE');
        // P L A Y F
        // I R E X M
        // B C D G H
        // K N O Q S
    ...
    it('encrypts according to rules', () => {
        ...
        const result = (0, playfair_1.playfairEncrypt)('HIDE THE GOLD IN THE TREESTUMP', { key: 'PLAYFAIR EXAMPLE' });
    ...
    it('decrypts correctly', () => {
        const result = (0, playfair_1.playfairDecrypt)('BMODZBXDNABEKUDMUIXMMOUVIF', { key: 'PLAYFAIR EXAMPLE' });

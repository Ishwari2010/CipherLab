...
exports.railFenceEncrypt = railFenceEncrypt;
exports.railFenceDecrypt = railFenceDecrypt;
function railFenceEncrypt(plaintext, options) {
    ...
    const grid = Array(rails).fill(0).map(() => []);
...
function railFenceDecrypt(ciphertext, options) {
    const { rails, offset = 0 } = options;
    const steps = [];
    if (rails < 2) {
        return {

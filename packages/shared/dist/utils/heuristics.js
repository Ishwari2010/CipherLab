...
exports.analyzeFrequency = analyzeFrequency;
exports.calculateChiSquare = calculateChiSquare;
exports.guessCipher = guessCipher;
const vigenere_1 = require("../ciphers/vigenere"); // We can reuse IC calculation
...
function calculateChiSquare(actualFreqs) {
    let chiSquare = 0;
    for (let i = 0; i < 26; i++) {
...
function guessCipher(ciphertext) {
    ...
    const guesses = [];
    const ic = (0, vigenere_1.calculateIC)(clean);
